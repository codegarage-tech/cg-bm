...
public class HttpRequestManager {
    ...
    public static HttpRequestManager.HttpResponse doRestPostRequest(String URL, JSONObject param, ArrayList<HttpParameter> header) {
        URL url = null;
    ...
    public static HttpRequestManager.HttpResponse readStream(HttpURLConnection httpURLConnection) {
        ...
        try {
            ...
            HttpRequestManager.HttpResponse var5 = new HttpRequestManager.HttpResponse(new Exception(httpURLConnection.getResponseMessage()));
            return var5;
